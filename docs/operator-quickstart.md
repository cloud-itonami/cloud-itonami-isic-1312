# Operator Quickstart — Community Textile Weaving

Shortest path from clone to a verified local dry-run for **ISIC 1312** (`cloud-itonami-isic-1312`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-1312.git
cd cloud-itonami-isic-1312
```
...
- Blueprint governor key: `textile-weaving-governor`
- Likely source path: `weaving.governor.cljc`
